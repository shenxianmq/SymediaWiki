...
有些用户在通过 Openlist 在进行 302 的过程中会发现无法请求到直链，究其原因是没有**关闭签名**，Openlist 的签名设置有两处，一个是全局的，一个是具体网盘的，如下图
...
打开你的 Openlist，在你的 115 网盘中找到同一个视频，右键这个视频，点击复制链接:
